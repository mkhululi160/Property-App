...
import { useCreatePropertyMutation } from '../redux/api/apiSlice';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={submitHandler} className="bg-white rounded-lg shadow-lg p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-gray-700 mb-2">HOA Fees ($/month)</label>
              <input
                type="number"
                name="hoaFees"
            ...
            <div>
              <label className="block text-gray-700 mb-2">Annual Tax ($)</label>
              <input
                type="number"
                name="taxAnnual"
                value={formData.taxAnnual}
                onChange={handleChange}
                className="input-field"
              />
            </div>
